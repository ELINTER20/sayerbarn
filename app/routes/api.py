...
def chat():
    ...
    system_prompt = (
        ...
        "Si la superficie es madera, TAMBIÉN necesitas el tipo de acabado (mate, semi mate o brillante) "
        "antes de poder recomendar; es un dato obligatorio igual que los demás para madera.\n"
        ...
        "- OBLIGATORIO: si el cliente responde 'Madera' a la pregunta de superficie, tu SIGUIENTE "
        "pregunta debe ser sobre el tipo de acabado (mate, semi mate o brillante). No pases a "
        "clima, área ni recomendación sin haber preguntado esto primero. No se vale saltarla aunque "
        "creas tener ya suficiente contexto para recomendar.\n"
